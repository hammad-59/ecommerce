   ...
   const { totalLength } = useSelector((state) => state.carts);
    ...
    <>
        <Navbar>
            ...
            <NavLink className={({isActive}) => isActive ? "border-b-2 pb-1 border-white" : "transition-all duration-80 pb-1 hover:border-b-2 hover:opacity-100 hover:translate"} to = "/user/userOrders">Orders</NavLink>
